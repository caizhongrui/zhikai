...
export async function listFilesTool(
	...
	try {
		if (block.partial) {
			...
			// DEBUG: Log the file list result
			console.log("[DEBUG listFilesTool] Files found:", files.length)
			console.log("[DEBUG listFilesTool] Result length:", result.length)
			console.log("[DEBUG listFilesTool] Result preview (first 500 chars):", result.substring(0, 500))
			...
			console.log("[DEBUG listFilesTool] About to push tool result, length:", result.length)
