...
import { ExtensionMessage, ExtensionState, MarketplaceInstalledMetadata, Command, KnowledgeBase } from "@roo/ExtensionMessage"
	...
	const handleMessage = useCallback(
		(event: MessageEvent) => {
			...
			case "knowledgeBaseList": {
				if (message.knowledgeBases) {
					setKnowledgeBases(message.knowledgeBases)
				}
				break
			}
			case "knowledgeBaseSelected": {
				setSelectedKnowledgeBaseId(message.selectedKnowledgeBaseId ?? null)
				break
			}
			}
		},
