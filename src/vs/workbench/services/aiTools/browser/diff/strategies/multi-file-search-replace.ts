...
export interface DiffStrategy {
	...
	applyDiff(originalContent: string, diffContent: string | Array<{ content: string; startLine?: number }>, startLine?: number, endLine?: number): Promise<DiffResult>;
