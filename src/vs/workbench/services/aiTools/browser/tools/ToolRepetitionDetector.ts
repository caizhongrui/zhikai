...
/**
 * Tool Repetition Detector - Detects consecutive identical tool calls to prevent loops
 */
		...
		if (
			...
			return {
				...
				askUser: {
					...
					messageDetail: `Tool repetition limit reached for: ${currentToolCallBlock.name}`,
				},
			};
		}
