...
// Copied from Kilocode src/utils/storage.ts and src/utils/safeWriteJson.ts
// Adapted for tianhe-zhikai-ide: complete implementation with file locking
 ...
 * Uses the default VSCode extension global storage path
 */
