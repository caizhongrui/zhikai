...
// AI Test
import './contrib/aiTest/browser/aiTest.contribution.js';

// AI Configuration
import './contrib/aiConfiguration/common/aiConfiguration.contribution.js';

// AI Inline Completions (Phase 3.5 - Enhanced with context extraction)
import './contrib/aiInlineCompletions/browser/aiInlineCompletions.contribution.js';

// AI Code Generation (Alt+T, Alt+C, Alt+G, Alt+M)
import './contrib/codeGen/browser/codeGen.contribution.js';

// Code Style Learning (Alt+Shift+L)
import './contrib/stylelearning/browser/styleLearning.contribution.js';

// Multi-Language Support (Java, TypeScript, Python)
import './contrib/multilang/browser/multilang.contribution.js';

// AI Chat Assistant (禁用 - 使用码弦Agent替代)
